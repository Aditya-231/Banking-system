...
if($_SERVER['REQUEST_METHOD']=='GET'){
    $sendersname=$_GET['sendersname'];
    $Account_Number=$_GET['sendersaccountnumber'];
}
...
<?php if(!empty($errors)): ?>
    ...
    <form class="transact" id="form" method="post" autofill="off">
        ...
        <div class="mb-3 debit">
            <label for="senderaccount" class="form-label">Account to be debited</label>
            <input type="text"   class="form-control debited" name="senderaccount" id="senderaccount" value=<?php 
            if($_SERVER['REQUEST_METHOD']=='GET') 
            {
                echo $Account_Number;
            }
            ...
            <label for="sendername" class="form-label">Senders Name</label>
            <input type="text" minlength="1" maxlength="14" class="form-control debited" name="sendername" id="sendername" value=<?php 
            if($_SERVER['REQUEST_METHOD']=='GET')
            { 
                echo $sendersname;
            }
        ...
        <section class="half">
        <div class="mb-3 debit">
            <label for="receiveraccount" class="form-label">Account to be credited</label>
            <input type="number" pattern="[0-9]{12}" class="form-control debited" name="receiveraccount" id="receiveraccount"  value="<?php echo $raccount ?>">
            ...
            <label for="receivername" class="form-label">Reciever Name</label>
            <input type="text" class="form-control debited" name="receivername" id="recievername" value="<?php echo $rname ?>">
