 ...
 $con->close();
    ?>
      ...
      echo "<div class='alert alert-success alert-dismissible fade show' role='alert'>
        ...
        <strong>Insertion Unsuccessful</strong><button type='button' class='close' data-dismiss='alert' aria-label='Close'>
        <span aria-hidden='true'>&times;</span>
        </button>
      </div>";
        }
        ...
        <div class="container ">
            <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" name="customer_city" class="customer_city" placeholder="Enter customer city Here"
                        required>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="email" pattern="+@+" name="email" class="email" placeholder="Enter your Mail id"
                        required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" name="DOB" id="DOB" max="2003-06-01" min="1920-06-01" required>
                </div>
            </div>
